    ...
    const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: "Você é um utilitário exclusivo de geração de dados mock. Seu único objetivo é retornar um array JSON válido baseado nos campos solicitados pelo usuário. NUNCA inclua saudações, textos explicativos, ou marcações markdown (como ```json) na resposta. Retorne estritamente o código JSON cru."
          },
          {
            role: "user",
            content: prompt
